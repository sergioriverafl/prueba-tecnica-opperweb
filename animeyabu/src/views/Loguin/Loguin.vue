        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="flex flex-col h-min-screen">
                ...
                <div class="flex flex-col gap-8 items-center justify-center h-full py-8">
                    ...
                    <div class="w-full md:w-80">
                        <h6 class="text-white text-center">Quieres registrarte? <a href="registro.html" class="text-secondary">Registrate</a></h6>
                    </div>
                </div>
            </div>


            <div class="hidden md:flex h-screen bg-terciary p-16">
